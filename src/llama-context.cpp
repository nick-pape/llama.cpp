        ...
        if (params.moe_expert_cache_size > 0) {
            ...
            if (gpu_backend == nullptr) {
                ...
                moe_cache = ggml_moe_cache_init(
                        gpu_backend, (int) model.hparams.n_layer,
                        params.moe_expert_cache_size, 0,
                        (ggml_moe_cache_policy) params.moe_expert_cache_policy);
...
llama_context_params llama_context_default_params() {
    llama_context_params result = {
        ...
        /*.moe_expert_cache_policy     =*/ 0,  // 0 = default (LFRU)
        /*.embeddings                  =*/ false,
        /*.offload_kqv                 =*/ true,
        /*.no_perf                     =*/ true,
        /*.op_offload                  =*/ true,
